                    ...
                    <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush">
                                ...
                                <tr>
                                    <th scope="col" class="sort" data-sort="name">Описание</th>
                                    <th scope="col" class="sort" data-sort="budget">Срок</th>
                                    <th scope="col" class="sort" data-sort="status">Статус</th>
                                    <th scope="col">Проект</th>
                                    <th scope="col" class="sort" data-sort="completion">Примечание</th>
                                    <th scope="col"></th>
                                </tr>
                                </thead>
                                <tbody class="list">
